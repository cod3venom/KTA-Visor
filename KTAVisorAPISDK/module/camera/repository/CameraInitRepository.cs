...
{
    public class CameraInitRepository
    {
     
        public async Task<HttpResponseMessage> init(InitCameraRequestTObject request)
        {
            string payload = JsonConvert.SerializeObject(request);
            return await HttpClientUtil.httpClient.POST("/api/hidden/cameras/init", payload);
        }
