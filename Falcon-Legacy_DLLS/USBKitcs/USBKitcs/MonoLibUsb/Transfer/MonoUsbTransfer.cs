...
// Type: USBKitcs.MonoLibUsb.Transfer.MonoUsbTransfer
...
namespace USBKitcs.MonoLibUsb.Transfer
{
  public struct MonoUsbTransfer
  {
    ...
    public MonoUsbTransfer(int numIsoPackets) => this.handle = MonoUsbApi.AllocTransfer(numIsoPackets);
    ...
    public string UniqueName() => string.Format("_-EP[{0}]EP-_", (object) this.handle);
    ...
    public MonoUsbError Cancel() => this.IsInvalid ? MonoUsbError.ErrorNoMem : (MonoUsbError) MonoUsbApi.CancelTransfer(this.handle);
    ...
    public MonoUsbError Submit() => this.IsInvalid ? MonoUsbError.ErrorNoMem : (MonoUsbError) MonoUsbApi.SubmitTransfer(this.handle);
