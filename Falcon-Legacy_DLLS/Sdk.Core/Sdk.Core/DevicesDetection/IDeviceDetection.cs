...
// Type: Sdk.Core.DevicesDetection.IDeviceDetection
...
namespace Sdk.Core.DevicesDetection
{
  ...
  {
    event DeviceDetectionHandle OnDeviceDetected;

    event DeviceDetectionHandle OnDeviceRemoved;

    event DeviceDetectionHandle OnDeviceMounted;
  }
}
