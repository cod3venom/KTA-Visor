...
// Type: FirstFloor.ModernUI.Presentation.LinkCollectionIcon
...
{
  public class LinkCollectionIcon : ObservableCollection<Link>
  {
    public LinkCollectionIcon()
    {
    }

    public LinkCollectionIcon(IEnumerable<Link> links)
    {
      if (links == null)
