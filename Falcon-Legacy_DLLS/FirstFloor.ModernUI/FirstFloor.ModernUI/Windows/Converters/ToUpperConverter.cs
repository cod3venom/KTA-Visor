...
// Type: FirstFloor.ModernUI.Windows.Converters.ToUpperConverter
...
namespace FirstFloor.ModernUI.Windows.Converters
{
  ...
  {
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture) => value != null ? (object) value.ToString().ToUpperInvariant() : (object) null;
